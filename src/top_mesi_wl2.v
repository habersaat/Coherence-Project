...
module top_mesi_wl2 (
    ...
    initial begin
        ...
        // All cores spin reading 0x100. After initial S-state fetch,
        // reads are local hits - near-zero bus traffic demonstrates
        // efficient MSI silent sharing.
        memory[ 0] = 32'h10002283;  // lw   t0, 0x100(zero)
