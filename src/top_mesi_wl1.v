...
module top_mesi_wl1 (
    ...
    initial begin
        ...
        // All 4 cores simultaneously read-increment-write a shared counter
        // at 0x100 in a tight loop. Generates a mix of all coherence event
        // types: BusRd (read miss), BusRdX (write miss), BusUpgr (S->M),
        // and interventions. Baseline workload for MSI vs MESI comparison.
