...
module top_mesi_wl3 (
    ...
    initial begin
        ...
        // All cores write same address in tight loop, no reads.
        // Every write requires BusRdX (previous write invalidated copy).
        // Maximum BusRdX and intervention traffic - worst-case MSI.
        memory[ 0] = 32'h10002023;  // sw   zero, 0x100(zero)
        memory[ 1] = 32'hffdff06f;  // jal  zero, -4
    end
