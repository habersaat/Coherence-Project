module cache_mesi (
    ...
    // -------------------------------------------------------------------------
    // Bus outputs which are driven by this controller when bus_grant is high
    ...
    // silent_upgrade: goes high for one cycle when a write hits an E-state
