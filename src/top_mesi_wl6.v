...
module top_mesi_wl6 (
    ...
    initial begin
        // Workload 6: Single-core read-modify-write loop
        memory[ 0] = 32'h00000413;  // 0x000: addi s0,zero,0  (core 0)
        memory[ 1] = 32'h03c0006f;   // 0x004: jal  zero,+60
        memory[ 4] = 32'h0000006f;    // 0x010: jal  zero,0     (core 1 idle)
        memory[ 8] = 32'h0000006f;    // 0x020: jal  zero,0     (core 2 idle)
        memory[12] = 32'h0000006f;    // 0x030: jal  zero,0     (core 3 idle)
        memory[16] = 32'h10002283;  // 0x040: lw   t0,0x100
        memory[17] = 32'h00128293;      // 0x044: addi t0,t0,1
        memory[18] = 32'h10502023;  // 0x048: sw   t0,0x100
        memory[19] = 32'hff5ff06f;               // 0x04C: jal  zero,-12
        memory[64] = 32'd0;
    end
